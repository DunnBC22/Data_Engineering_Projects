...
#
#  This sub-DAG imputes missing string values with the mode value 
...
def sub_dag_impute_with_mode(table_name: str,
    ...
    impute_missing_values_mode = DAG(
    ...
    for col in column_names:
        ...
        PostgresOperator(
            task_id=f"impute_{col}_with_mode",
            sql="/sql/impute_with_mode.sql",
            params=parameters,
            postgres_conn_id=postgres_conn_name,
            dag=impute_missing_values_mode)
    
    return impute_missing_values_mode