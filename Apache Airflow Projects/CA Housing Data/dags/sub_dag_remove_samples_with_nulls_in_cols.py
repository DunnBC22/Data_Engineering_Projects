...
def sub_dag_remove_samples_with_nulls(table_name: str,
    ...
    Args:
        ...
        column_names list[str]: This is the list of columns to 
            check for missing samples. If a sample has a missing 
            value in one of these columns, remove that sample.
