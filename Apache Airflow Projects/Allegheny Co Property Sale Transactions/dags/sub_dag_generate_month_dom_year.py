...
#################################################################
#
#  Creates the sub-DAG that includes the following columns for
#  each column that is a date:
#       - month
#       - day of month, & 
#       - year.
#
...
def sub_dag_generate_month_dom_year_of_date(table_name: str,
    ...
    Args:
        ...
        column_names list[str]: This is the list of column 
            names that fow which we need to have year, month, 
            and day of month generated.
