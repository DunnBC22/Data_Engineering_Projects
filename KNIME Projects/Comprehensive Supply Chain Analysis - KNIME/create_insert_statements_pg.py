...
if __name__ == "__main__":
    csv_file_path = 'Supply Chain Shipment Pricing Data-Apache NiFi Project/data/dataset.csv'
    ...
    output_file_path = 'Supply Chain Shipment Pricing Data-Apache NiFi Project/pg_init/3_insert_data.sql'
